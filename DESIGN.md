...
- Automated fixture coverage includes JDI target exit, detach/kill, step-over stack/locals, sidecar-process death, an MCP `attach -> break_at -> cont -> locals -> inspect -> kill` smoke, and Java sidecar self-tests for JSON/config/RPC/value limits.
